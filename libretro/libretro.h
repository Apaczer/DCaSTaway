...
#define RETRO_ENVIRONMENT_SET_SERIALIZATION_QUIRKS 71
...
#define RETRO_DEVICE_SUBCLASS(base, id) (((id + 1) << 8) | base)
...
/* Message target/type */
#define RETRO_MESSAGE_TARGET_ALL 0
#define RETRO_MESSAGE_TARGET_OSD 1
#define RETRO_MESSAGE_TARGET_LOG 2
#define RETRO_MESSAGE_TYPE_NOTIFICATION 0
#define RETRO_MESSAGE_TYPE_NOTIFICATION_ALT 1
#define RETRO_MESSAGE_TYPE_STATUS 2
#define RETRO_MESSAGE_TYPE_PROGRESS 3

/* Serialization quirks */
#define RETRO_SERIALIZATION_QUIRK_INCOMPLETE 1
